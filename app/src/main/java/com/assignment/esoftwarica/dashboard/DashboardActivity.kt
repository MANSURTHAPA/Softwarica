...
class DashboardActivity : AppCompatActivity() {
    ...
    private fun loadlist(){
        if (lisfOfStudent.size==0){
            lisfOfStudent.add(Student("Mansur Thapa", "20", "Bhaktapur", "Male"));
            lisfOfStudent.add(Student("Dikshya", "20", "Bhaktapur", "Female"));
            lisfOfStudent.add(Student("Rita", "20", "Bhaktapur", "Female"));
        }
    }
    companion object {
